...
public class ObstacleAvoidance : ISteering
{
    ...
    public Vector3 GetDir()
    {
        ...
        //RaycastHit hit;
        //if (Physics.SphereCast(_from.position, _radius, Vector3.zero, out hit, 0, _mask))
        //{
        //    float distance = Vector3.Distance(hit.collider.transform.position, _from.position);
        //    Vector3 dirFromObs = (_from.position - hit.collider.transform.position).normalized* ((_radius - distance) / _radius);
        //    dir += dirFromObs;
        //}
